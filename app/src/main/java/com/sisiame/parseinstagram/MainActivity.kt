...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btn_submit).setOnClickListener {
            val desc = findViewById<EditText>(R.id.field_desc).text.toString()
            ...
            if(photoFile != null) {
                ...
                Toast.makeText(this, "There was a problem with your photo", Toast.LENGTH_SHORT).show()
            }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == Companion.CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                // by this point we have the camera photo on disk
                val takenImage = BitmapFactory.decodeFile(photoFile!!.absolutePath)
                // RESIZE BITMAP, see section below
                // Load the taken image into a preview
                val ivPreview: ImageView = findViewById(R.id.img_preview)
    ...
    private fun onLaunchCamera() {
        ...
        if (photoFile != null) {
            val fileProvider: Uri =
                FileProvider.getUriForFile(this, "com.codepath.fileprovider.parseinstagram", photoFile!!)
